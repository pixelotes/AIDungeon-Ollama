# Create a new file: aidungeon/keywords.py
# This module contains all keyword definitions to avoid circular imports
...
def get_all_keywords():
    ...
    important_words = {
        # Action verbs
        'open', 'close', 'take', 'drop', 'examine', 'attack', 'defend', 
        'climb', 'jump', 'sneak', 'hide', 'search', 'pull', 'push',
        'break', 'repair', 'read', 'write', 'listen', 'smell', 'taste',
        'unlock', 'steal', 'trade', 'give', 'throw', 'catch', 'shoot', 
        'stab', 'slash', 'block', 'parry', 'dodge',
